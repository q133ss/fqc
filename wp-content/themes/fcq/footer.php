        ...
        <div class="footer__inner">
          ...
          <div class="footer__bottom">
            ...
            <div class="footer__menu">
              ...
              <div class="footer__menu-item">
                <a class="footer__menu-link" href="shipping.html">Services</a>
              </div>
              <div class="footer__menu-item">
                <a class="footer__menu-link" href="price.html">Price</a>
              </div>
              <div class="footer__menu-item">
                <a class="footer__menu-link" href="how-work.html">How work?</a>
              </div>
              <div class="footer__menu-item">
                <a class="footer__menu-link" href="about-us.html">About</a>
              </div>
              <div class="footer__menu-item">
                <a class="footer__menu-link" href="contacts.html">Contacts</a>
              </div>
            </div>
