        ...
        <div class="footer__inner">
          ...
          <div class="footer__bottom">
            <div class="footer__logo">
              <a class="footer__logo-link" href="/">FCQ</a>
            </div>
  ...
  <?php get_template_part('parts/calc', 'part'); ?>
  ...
  <script defer src="<?php echo get_template_directory_uri(); ?>/assets/js/main.min.js"></script>
</body>
