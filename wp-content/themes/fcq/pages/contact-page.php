        ...
        <div class="container-fluid">
          ...
          <div class="contacts__items">
            ...
            <div class="contacts__item">
              ...
              <p class="contacts__item-subtitle">Поможем решить возникшие трудности в работе</p>

              <a class="contacts__item-link contacts__item-link--btn" href="#">

                <u>Создать обращение</u>
            ...
            <div class="contacts__item">
              ...
              <h6 class="contacts__item-title">Документация по платформе</h6>

              <p class="contacts__item-subtitle contacts__item-subtitle--yt">Поможем решить возникшие трудности в работе

              </p>

              <p class="contacts__item-text">Ссылка на видео - </p>

              <a class="contacts__item-link contacts__item-link--btn contacts__item-link--yt"

                href="https://youtu.be/N1P3KNHidec">

                <p>Ссылка на видео</p>

                <u>https://youtu.be/N1P3KNHidec</u>
            ...
            <div class="contacts__item">
              ...
              <div class="contacts__item-box">
                ...
                <div class="contacts__box-info">
                  ...
                  <h6 class="contacts__item-title">Партнёрство и сотрудничество</h6>

                  <p class="contacts__item-subtitle">По вопросам взаимодействия, партнёрских программ

                    и развития совместных проектов</p>

                </div>

                <div class="contacts__item-links">

                  <a class="contacts__item-link" href="tel:+79295174678">+7 (939) 111-05-34</a>

                  <a class="contacts__item-link" href="mailto:fcq-fulfillment@yandex.ru">Почта &nbsp; <u>partners@togotop.ru</u></a>
...
и продвижение на Wildberries</p>
                ...
                <div class="contacts__item-links">
                  ...
                  <a class="contacts__item-link" href="mailto:fcq-fulfillment@yandex.ru">Почта &nbsp; <u>info@togotop.ru</u></a>
